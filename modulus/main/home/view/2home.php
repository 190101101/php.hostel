        ...
        <div class="row featuredContainer">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 joomla plugins component">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/12.jpg" alt="product" class="img-responsive">
                    ...
                    <div class="item-content">
                        ...
                        <div class="item-profile">
                            <div class="profile-title">
                                <div class="img-wrapper"><img src="<?php echo MAIN; ?>img/profile/1.jpg" alt="profile" class="img-responsive img-circle"></div>
                                <span>PsdBosS</span>
                            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wordpress plugins">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/13.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 joomla component">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/14.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wordpress joomla plugins">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/15.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wordpress">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/16.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wordpress joomla psd">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/17.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 component">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/18.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wordpress psd">
                <div class="single-item-grid">
                    <div class="item-img">
                        <img src="<?php echo MAIN; ?>img/product/19.jpg" alt="product" class="img-responsive">
                        <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                    </div>
                    <div class="item-content">
                        <div class="item-info">
...
<div class="trending-products-area section-space-default">                
    ...
    <div class="container=fluid">
        <div class="fox-carousel dot-control-textPrimary" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="false" data-r-x-small-dots="true" data-r-x-medium="2" data-r-x-medium-nav="false" data-r-x-medium-dots="true" data-r-small="2" data-r-small-nav="false" data-r-small-dots="true" data-r-medium="3" data-r-medium-nav="false" data-r-medium-dots="true" data-r-large="4" data-r-large-nav="false" data-r-large-dots="true">
            <div class="single-item-grid">
                <div class="item-img">
                    <img src="<?php echo MAIN; ?>img/product/20.jpg" alt="product" class="img-responsive">
                    <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                </div>
                <div class="item-content">
                    <div class="item-info">
            ...
            <div class="single-item-grid">
                <div class="item-img">
                    <img src="<?php echo MAIN; ?>img/product/21.jpg" alt="product" class="img-responsive">
                    <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                </div>
                <div class="item-content">
                    <div class="item-info">
            ...
            <div class="single-item-grid">
                <div class="item-img">
                    <img src="<?php echo MAIN; ?>img/product/22.jpg" alt="product" class="img-responsive">
                    <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                </div>
                <div class="item-content">
                    <div class="item-info">
            ...
            <div class="single-item-grid">
                <div class="item-img">
                    <img src="<?php echo MAIN; ?>img/product/23.jpg" alt="product" class="img-responsive">
                    <div class="trending-sign" data-tips="Trending"><i class="fa fa-bolt" aria-hidden="true"></i></div>
                </div>
                <div class="item-content">
                    <div class="item-info">
    ...
    <div class="author-banner-wrapper">
        <div id="ri-grid" class="author-banner-bg ri-grid header text-center">
            <ul class="ri-grid-list">
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/2.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/3.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/4.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/5.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/6.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/7.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/8.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/9.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/2.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/3.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/5.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo MAIN; ?>img/banner/6.jpg" alt=""></a></li>
