          ...
          <div class="container">
              <div class="row">                         
                  <div class="col-lg-2 col-md-2 col-sm-2 hidden-xs">
                      <div class="logo-area">
                          <a href="index.htm"><img class="img-responsive" src="<?php echo MAIN; ?>img/logo.png" alt="logo"></a>
                      </div>
                  </div> 
                                          ...
                                          <div class="cart-single-product">
                                              <div class="media">
                                                  <div class="pull-left cart-product-img">
                                                      <a href="#">
                                                          <img class="img-responsive" alt="product" src="<?php echo MAIN; ?>img/product/more2.jpg">
                                                      </a>
                                                  </div>
                                      ...
                                      <li>
                                          <div class="cart-single-product">
                                              <div class="media">
                                                  <div class="pull-left cart-product-img">
                                                      <a href="#">
                                                          <img class="img-responsive" alt="product" src="<?php echo MAIN; ?>img/product/more3.jpg">
                                                      </a>
                                                  </div>
                                                  <div class="media-body cart-content">
                                                      <ul>
